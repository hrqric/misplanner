    ...
    {/* Features Section */}
      <section className="p-10 grid md:grid-cols-3 gap-6 h-130">
        <div className="bg-gray-100 rounded-2xl p-6 shadow">
          <h2 className="text-[35px] font-semibold mb-2 text-[#005791]">Gestão inteligente do tempo</h2>
        ...
        <div className="bg-gray-100 rounded-2xl p-6 shadow">
          <h2 className="text-[35px] font-semibold mb-2 text-[#005791]">Estudo com foco e metas</h2>
        ...
        <div className="bg-gray-100 rounded-2xl p-6 shadow">
          <h2 className="text-[35px] font-semibold mb-2 text-[#005791]">Ajuda instantânea com IA</h2>
      ...
      {/* Footer */}
      <footer className="mt-auto bg-[#005791] text-[#f3f4f7] text-center p-4">
